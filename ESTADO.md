...
- Próximo paso: conectar el CTA del paywall a un link real de checkout de Hotmart (hoy manda a `/login`, no a Hotmart) y probar una compra real de punta a punta.
